...
G_GRID_COARSE = np.round(np.arange(0.020, 0.161, 0.005), 3)
...
for spec in SPECIFICATIONS:
    ...
    if best_pop_coarse['sigma'] is not None:
        ...
        sigma_fine_pop = np.round(np.arange(center_sigma_pop - 0.03, center_sigma_pop + 0.013, 0.001), 3)
    ...
    if fine_search_regions:
        ...
        g_fine_combined = g_fine_combined[(g_fine_combined >= 0.01) & (g_fine_combined <= 0.20)]
...
print("\n" + "="*80)
print("SUMMARY: HEAD OF HOUSEHOLD ROBUSTNESS")
print("="*80)
