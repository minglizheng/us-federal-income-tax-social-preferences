...
STD_DEDUCTION = 25100                # 2021 MFJ standard deduction
...
G_GRID = np.arange(0.105, 0.165, 0.001)
SIGMA_GRID = np.arange(1.105, 1.205, 0.001)
...
# Preferential tax (2021 MFJ thresholds: 0% up to $80,800; 15% up to $501,600)
